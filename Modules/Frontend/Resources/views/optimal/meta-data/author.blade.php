<meta charset="utf-8">
<title>Posts by {{$author->display_name}}</title>
...
@endif
<meta property="og:title" content="Posts by {{$author->display_name}}">
<meta property="og:url" content="{{url()->current()}}">
<meta property="og:description" content="{{$author->about}}">
<meta name="description" content="{{$author->about}}">
<meta property="og:image" content="{{$author->image}}">
<meta property="og:image:secure_url" content="{{$author->image}}">
<meta name=”twitter:title” content="Posts by {{$author->display_name}}">
<meta name=”twitter:description” content="{{$author->about}}">
