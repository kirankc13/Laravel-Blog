...
@section('meta_tags')
    @include('frontend::optimal.meta-data.search')
@endsection
@section('content')
        ...
        <div class="row">
            <div class="col-md-8 grid-sidebar" id="content">
                <div class="jl_cat_mid_title">
                     <h3 class="categories-title title">Search results For "{{$query}}"</h3>
                </div>
                @if($posts)
                    ...
                    <div class="container">
                        <div class="row main_content">
                            ...
                            <div class="col-md-12 page_error_404">
                                <h4 class="big">No results</h4>
                                <p class="description">Oops! We could not find any posts related to your keyword.</p>
                                ...
                                <a class="link_home404" href="{{route('home')}}"> Back to Home </a>
                            </div>
                        </div>
                    </div>
                </section>
