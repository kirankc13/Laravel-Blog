    ...
    <div class="row justify-content-between">
        <div class="col-lg-3 g-mb-30">
            <a class="d-inline-block mb-3" href="">
                <img src="{{ asset('assets_unify/img/logo/103x15.png') }}" alt="Image Description"
        ...
        <div class="col-sm-6 col-lg-3 g-mb-30">
            ...
            <ul class="list-inline mb-0">
                @if (isset($settings['facebook-link']))
                    <li class="list-inline-item g-mx-2">
                        <a class="u-icon-v1 u-icon-size--sm u-icon-slide-up--hover g-color-blue g-bg-blue-opacity-0_1 g-color-blue--hover rounded-circle"
                            target="_blank" href="{{ $settings['facebook-link'] }}">
                ...
                @if (isset($settings['twitter-link']))
                    <li class="list-inline-item g-mx-2">
                        <a class="u-icon-v1 u-icon-size--sm u-icon-slide-up--hover g-color-cyan g-bg-cyan-opacity-0_1 g-color-cyan--hover rounded-circle"
                            target="_blank" href="{{ $settings['twitter-link'] }}">
                ...
                @if (isset($settings['instagram-link']))
                    <li class="list-inline-item g-mx-2">
                        <a class="u-icon-v1 u-icon-size--sm u-icon-slide-up--hover g-color-indigo g-bg-indigo-opacity-0_1 g-color-indigo--hover rounded-circle"
                            target="_blank" href="{{ $settings['instagram-link'] }}">
