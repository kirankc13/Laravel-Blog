        ...
        <header class="section-header">
			...
			<header class="box-typical-header">
				<div class="tbl-row">
					...
					<a href="{{route('users.index')}}" class="btn btn-sm btn-success" style="float: right;"><i aria-hidden="true" class="fa fa-undo"></i> Back to {{$data['panel_name']}} List
					</a>
					</div>
				</div>
			</header>
			...
			@include('admin.components.messages')
				{!! Form::model($user, ['id'=>'validate-form','method' => 'PATCH','route' => ['users.update', $user->id]]) !!}
