!(function (e, t) {
                ...
                if (null != (o = arguments[a]))
                    for (i in o)
                        (e = s[i]),
                            ...
                            "__proto__" !== i &&
                                s !== n &&
                                (d && n && (f.isPlainObject(n) || (t = f.isArray(n))) ? (t ? ((t = !1), (r = e && f.isArray(e) ? e : [])) : (r = e && f.isPlainObject(e) ? e : {}), (s[i] = f.extend(d, r, n))) : void 0 !== n && (s[i] = n));
            return s;
        }),
        f.extend({
            ...
            map: function (e, t, n) {
                var i,
                    ...
                    s = 0,
                    a = [];
                if (y(e)) for (i = e.length; s < i; s++) null != (o = t(e[s], s, n)) && a.push(o);
            ...
            proxy: function (e, t) {
                var n, i, r;
                if (("string" == typeof t && ((r = e[t]), (t = e), (e = r)), f.isFunction(e)))
                    return (
    ...
    var b = (function (e) {
        ...
        (oe.matchesSelector = function (e, t) {
            if (((e.ownerDocument || e) !== f && p(e), (t = t.replace(X, "='$1']")), n.matchesSelector && v && !_[t + " "] && (!m || !m.test(t)) && (!g || !g.test(t))))
                try {
                    var i = y.call(e, t);
                        ...
                        : function (t, n, l) {
                              ...
                              if (g) {
                                  ...
                                  if (((h = [s ? g.firstChild : g.lastChild]), s && y)) {
                                      for (
                                          b = (f = (d = (c = (u = (p = g)[w] || (p[w] = {}))[p.uniqueID] || (u[p.uniqueID] = {}))[e] || [])[0] === x && d[1]) && d[2], p = f && g.childNodes[f];
                                      ...
                                      for (
                                          ;
                                          (p = (++f && p && p[v]) || (b = f = 0) || h.pop()) &&
                                          ((a ? p.nodeName.toLowerCase() !== m : 1 !== p.nodeType) || !++b || (y && ((c = (u = p[w] || (p[w] = {}))[p.uniqueID] || (u[p.uniqueID] = {}))[e] = [x, b]), p !== t));
            ...
            return (
                ...
                se(function (r, s, a, l) {
                    var d,
                        ...
                        m = n ? (o || (r ? e : h || i) ? [] : s) : g;
                    if ((n && n(g, m, a, l), i)) for (d = ye(m, f), i(d, [], a, l), c = d.length; c--; ) (u = d[c]) && (m[f[c]] = !(g[f[c]] = u));
                    if (r) {
                        if (o || e) {
                            if (o) {
            ...
            for (
                ...
                if ((n = i.relative[e[l].type])) p = [ge(me(p), n)];
                    ...
                    if ((n = i.filter[e[l].type].apply(null, e[l].matches))[w]) {
                        ...
                        return be(l > 1 && me(p), l > 1 && ve(e.slice(0, l - 1).concat({ value: " " === e[l - 2].type ? "*" : "" })).replace(F, "$1"), n, l < o && we(e.slice(l, o)), o < r && we((e = e.slice(o))), o < r && ve(e));
                    }
                    p.push(n);
                }
            return me(p);
        ...
        return (
            ...
            (s = oe.tokenize = function (e, t) {
                ...
                for (a = e, l = [], d = i.preFilter; a; ) {
                    for (s in ((n && !(o = R.exec(a))) || (o && (a = a.slice(o[0].length) || a), l.push((r = []))),
                    (n = !1),
                    (o = B.exec(a)) && ((n = o.shift()), r.push({ value: n, type: o[0].replace(F, " ") }), (a = a.slice(n.length))),
                    i.filter))
                        !(o = V[s].exec(a)) || (d[s] && !(o = d[s](o))) || ((n = o.shift()), r.push({ value: n, type: s, matches: o }), (a = a.slice(n.length)));
                    if (!n) break;
                }
                ...
                remove: function () {
                    return (
                        f.each(arguments, function (e, t) {
                            for (var n; (n = f.inArray(t, r, n)) > -1; ) r.splice(n, 1), n <= a && a--;
                        }),
                        this
                    );
                },
    ...
    f.extend({
        ...
        when: function (e) {
            ...
            if (a > 1) for (t = new Array(a), n = new Array(a), i = new Array(a); r < a; r++) s[r] && f.isFunction(s[r].promise) ? s[r].promise().progress(c(r, n, t)).done(c(r, i, s)).fail(d.reject) : --l;
    ...
    (u.ownFirst = "0" === L),
        ...
        f(function () {
            ...
            (n = i.getElementsByTagName("body")[0]) &&
                ...
                void 0 !== t.style.zoom && ((t.style.cssText = "display:inline;margin:0;border:0;padding:1px;width:1px;zoom:1"), (u.inlineBlockNeedsLayout = e = 3 === t.offsetWidth), e && (n.style.zoom = 1)),
                n.removeChild(o));
        }),
        (function () {
    ...
    function W(e, t, i, o) {
        if (P(e)) {
            var r,
                ...
                d = l ? f.cache : e,
                c = l ? e[a] : e[a] && a;
            if ((c && d[c] && (o || d[c].data)) || void 0 !== i || "string" != typeof t)
                return (
                    c || (c = l ? (e[a] = n.pop() || f.guid++) : a),
                    d[c] || (d[c] = l ? {} : { toJSON: f.noop }),
                    ("object" != typeof t && "function" != typeof t) || (o ? (d[c] = f.extend(d[c], t)) : (d[c].data = f.extend(d[c].data, t))),
                    (s = d[c]),
                    o || (s.data || (s.data = {}), (s = s.data)),
                    void 0 !== i && (s[f.camelCase(t)] = i),
                    "string" == typeof t ? null == (r = s[t]) && (r = s[f.camelCase(t)]) : (r = s),
                    r
                );
        }
    }
    ...
    var V = function (e, t, n, i, o, r, s) {
            var a = 0,
                l = e.length,
                d = null == n;
            if ("object" === f.type(n)) for (a in ((o = !0), n)) V(e, t, a, n[a], !0, r, s);
            else if (
                void 0 !== i &&
                ((o = !0),
                f.isFunction(i) || (s = !0),
    ...
    !(function () {
        ...
        (e.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>"),
            ...
            (u.html5Clone = "<:nav></:nav>" !== i.createElement("nav").cloneNode(!0).outerHTML),
            (n.type = "checkbox"),
            (n.checked = !0),
            t.appendChild(n),
    ...
    function ne(e, t) {
        ...
        if (!r) for (r = [], n = e.childNodes || e; null != (i = n[o]); o++) !t || f.nodeName(i, t) ? r.push(i) : f.merge(r, ne(i, t));
    ...
    function ae(e, t, n, i, o) {
            ...
            if ((s = e[m]) || 0 === s)
                if ("object" === f.type(s)) f.merge(g, s.nodeType ? [s] : s);
                    ...
                    if ((!u.leadingWhitespace && K.test(s) && g.push(t.createTextNode(K.exec(s)[0])), !u.tbody))
                        for (r = (s = "table" !== d || re.test(s) ? ("<table>" !== p[1] || re.test(s) ? 0 : l) : l.firstChild) && s.childNodes.length; r--; )
        ...
        for (l && v.removeChild(l), u.appendChecked || f.grep(ne(g, "input"), se), m = 0; (s = g[m++]); )
            ...
            else if (((a = f.contains(s.ownerDocument, s)), (l = ne(v.appendChild(s), "script")), a && ie(l), n)) for (r = 0; (s = l[r++]); ) J.test(s.type || "") && n.push(s);
        return (l = null), v;
    }
    !(function () {
        var t,
        ...
        for (t in { submit: !0, change: !0, focusin: !0 }) (n = "on" + t), (u[t] = n in e) || (o.setAttribute(n, "t"), (u[t] = !1 === o.attributes[n].expando));
        o = null;
    })();
    ...
    (f.event = {
                ...
                for (
                    ...
                    (h = g = (r = pe.exec(t[a]) || [])[1]),
                        ...
                        h &&
                            ...
                            (d = f.event.special[h] || {}),
                            (u = f.extend({ type: h, origType: g, data: i, handler: n, guid: n.guid, selector: o, needsContext: o && f.expr.match.needsContext.test(o), namespace: v.join(".") }, l)),
                            (p = s[h]) || (((p = s[h] = []).delegateCount = 0), (d.setup && !1 !== d.setup.call(e, i, v, c)) || (e.addEventListener ? e.addEventListener(h, c, !1) : e.attachEvent && e.attachEvent("on" + h, c))),
            ...
            if (m && (c = m.events)) {
                for (d = (t = (t || "").match(D) || [""]).length; d--; )
                    if (((h = g = (a = pe.exec(t[d]) || [])[1]), (v = (a[2] || "").split(".").sort()), h)) {
                        for (u = f.event.special[h] || {}, p = c[(h = (i ? u.delegateType : u.bindType) || h)] || [], a = a[2] && new RegExp("(^|\\.)" + v.join("\\.(?:.*\\.|)") + "(\\.|$)"), l = r = p.length; r--; )
                            (s = p[r]),
                                (!o && g !== s.origType) ||
                                    (n && n.guid !== s.guid) ||
                                    (a && !a.test(s.namespace)) ||
                                    (i && i !== s.selector && ("**" !== i || !s.selector)) ||
                                    (p.splice(r, 1), s.selector && p.delegateCount--, u.remove && u.remove.call(e, s));
        ...
        trigger: function (t, n, o, r) {
            ...
            if (
                ...
                3 !== o.nodeType &&
                    ...
                    (a = g.indexOf(":") < 0 && "on" + g),
                    ((t = t[f.expando] ? t : new f.Event(g, "object" == typeof t && t)).isTrigger = r ? 2 : 3),
                    (t.namespace = m.join(".")),
                ...
                for (h = 0; (l = v[h++]) && !t.isPropagationStopped(); )
                    (t.type = h > 1 ? d : u.bindType || g),
                        (s = (f._data(l, "events") || {})[t.type] && f._data(l, "handle")) && s.apply(l, n),
                        (s = a && l[a]) && s.apply && P(l) && ((t.result = s.apply(l, n)), !1 === t.result && t.preventDefault());
        ...
        dispatch: function (e) {
            ...
            if (((l[0] = e), (e.delegateTarget = this), !c.preDispatch || !1 !== c.preDispatch.call(this, e))) {
                for (a = f.event.handlers.call(this, e, d), t = 0; (r = a[t++]) && !e.isPropagationStopped(); )
                    for (e.currentTarget = r.elem, n = 0; (s = r.handlers[n++]) && !e.isImmediatePropagationStopped(); )
                        (e.rnamespace && !e.rnamespace.test(s.namespace)) ||
                            ((e.handleObj = s), (e.data = s.data), void 0 !== (i = ((f.event.special[s.origType] || {}).handle || s.handler).apply(r.elem, l)) && !1 === (e.result = i) && (e.preventDefault(), e.stopPropagation()));
        ...
        (f.Event = function (e, t) {
            ...
            e && e.type ? ((this.originalEvent = e), (this.type = e.type), (this.isDefaultPrevented = e.defaultPrevented || (void 0 === e.defaultPrevented && !1 === e.returnValue) ? fe : he)) : (this.type = e),
                t && f.extend(this, t),
    ...
    function Ae(e, t) {
        if (1 === t.nodeType && f.hasData(e)) {
            var n,
                ...
                s = f._data(t, r),
                a = r.events;
            if (a) for (n in (delete s.handle, (s.events = {}), a)) for (i = 0, o = a[n].length; i < o; i++) f.event.add(t, n, a[n][i]);
    ...
    function je(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            "script" === n && t.text !== e.text
                ...
                : "object" === n
                ? (t.parentNode && (t.outerHTML = e.outerHTML), u.html5Clone && e.innerHTML && !f.trim(t.innerHTML) && (t.innerHTML = e.innerHTML))
        ...
        if (h && ((o = (c = ae(t, e[0].ownerDocument, !1, e, i)).firstChild), 1 === c.childNodes.length && (c = o), o || i)) {
            ...
            if (a)
                for (d = l[l.length - 1].ownerDocument, f.map(l, $e), p = 0; p < a; p++)
                    (s = l[p]), J.test(s.type || "") && !f._data(s, "globalEval") && f.contains(d, s) && (s.src ? f._evalUrl && f._evalUrl(s.src) : f.globalEval((s.text || s.textContent || s.innerHTML || "").replace(Te, "")));
            c = o = null;
        }
        return e;
    }
    ...
    f.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (
                (u.html5Clone || f.isXMLDoc(e) || !ye.test("<" + e.nodeName + ">") ? (r = e.cloneNode(!0)) : ((Ce.innerHTML = e.outerHTML), Ce.removeChild((r = Ce.firstChild))),
                !((u.noCloneEvent && u.noCloneChecked) || (1 !== e.nodeType && 11 !== e.nodeType) || f.isXMLDoc(e)))
            )
                for (i = ne(r), a = ne(e), s = 0; null != (o = a[s]); ++s) i[s] && je(o, i[s]);
            if (t)
                if (n) for (a = a || ne(e), i = i || ne(r), s = 0; null != (o = a[s]); s++) Ae(o, i[s]);
                else Ae(e, r);
        ...
        cleanData: function (e, t) {
            for (var i, o, r, s, a = 0, l = f.expando, d = f.cache, c = u.attributes, p = f.event.special; null != (i = e[a]); a++)
                if ((t || P(i)) && (s = (r = i[l]) && d[r])) {
                    if (s.events) for (o in s.events) p[o] ? f.event.remove(i, o) : f.removeEvent(i, o, s.handle);
    ...
    function Oe(e) {
        ...
        return (
            n ||
                (("none" !== (n = He(e, t)) && n) ||
                    ((t = ((Le = (Le || f("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement))[0].contentWindow || Le[0].contentDocument).document).write(), t.close(), (n = He(e, t)), Le.detach()),
                (De[e] = n)),
            n
        );
    }
        ...
        function c() {
            ...
            p.appendChild(l),
                ...
                e.getComputedStyle &&
                    ...
                    ((c = d.appendChild(i.createElement("div"))).style.cssText = d.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:0"),
                ...
                (r = 0 === d.getClientRects().length) &&
                    ...
                    (r = 0 === c[0].offsetHeight) && ((c[0].style.display = ""), (c[1].style.display = "none"), (r = 0 === c[0].offsetHeight))),
                p.removeChild(l);
        }
        d.style &&
        ...
        ? ((ze = function (t) {
          ...
          (We = function (e, t, n) {
              var i,
                  ...
                  a = e.style;
              return (
                  ("" !== (s = (n = n || ze(e)) ? n.getPropertyValue(t) || n[t] : void 0) && void 0 !== s) || f.contains(e.ownerDocument, e) || (s = f.style(e, t)),
                  n && !u.pixelMarginRight() && qe.test(s) && Pe.test(t) && ((i = a.width), (o = a.minWidth), (r = a.maxWidth), (a.minWidth = a.maxWidth = a.width = s), (s = n.width), (a.width = i), (a.minWidth = o), (a.maxWidth = r)),
                  void 0 === s ? s : s + ""
              );
          }))
        : Ie.currentStyle &&
          ...
          (We = function (e, t, n) {
              var i,
                  ...
                  a = e.style;
              return (
                  null == (s = (n = n || ze(e)) ? n[t] : void 0) && a && a[t] && (s = a[t]),
                  qe.test(s) && !Fe.test(t) && ((i = a.left), (r = (o = e.runtimeStyle) && o.left) && (o.left = e.currentStyle.left), (a.left = "fontSize" === t ? "1em" : s), (s = a.pixelLeft + "px"), (a.left = i), r && (o.left = r)),
                  void 0 === s ? s : s + "" || "auto"
              );
          }));
    var Be = /alpha\([^)]*\)/i,
    ...
    function Ke(e) {
        if (e in Je) return e;
        for (var t = e.charAt(0).toUpperCase() + e.slice(1), n = Ge.length; n--; ) if ((e = Ge[n] + t) in Je) return e;
    }
    function Ze(e, t) {
        for (var n, i, o, r = [], s = 0, a = e.length; s < a; s++)
            (i = e[s]).style &&
                ...
                (n = i.style.display),
                t
                    ? (r[s] || "none" !== n || (i.style.display = ""), "" === i.style.display && U(i) && (r[s] = f._data(i, "olddisplay", Oe(i.nodeName))))
                    : ((o = U(i)), ((n && "none" !== n) || !o) && f._data(i, "olddisplay", o ? n : f.css(i, "display"))));
    ...
    function tt(e, t, n, i, o) {
        for (var r = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0, s = 0; r < 4; r += 2)
            "margin" === n && (s += f.css(e, n + X[r], !0, o)),
                i
                    ? ("content" === n && (s -= f.css(e, "padding" + X[r], !0, o)), "margin" !== n && (s -= f.css(e, "border" + X[r] + "Width", !0, o)))
                    : ((s += f.css(e, "padding" + X[r], !0, o)), "padding" !== n && (s += f.css(e, "border" + X[r] + "Width", !0, o)));
        return s;
    }
    function nt(e, t, n) {
        var i = !0,
    ...
    f.extend({
        ...
        style: function (e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                if (
                    ("string" === (r = typeof n) && (o = B.exec(n)) && o[1] && ((n = Y(e, t, o)), (r = "number")),
                    null != n &&
                        n == n &&
                        ("number" === r && (n += (o && o[3]) || (f.cssNumber[a] ? "" : "px")), u.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), !(s && "set" in s && void 0 === (n = s.set(e, n, i)))))
                )
                    try {
                        l[t] = n;
                    } catch (e) {}
        ...
        css: function (e, t, n, i) {
            ...
            return (
                ...
                (s = f.cssHooks[t] || f.cssHooks[a]) && "get" in s && (r = s.get(e, !0, n)),
                void 0 === r && (r = We(e, t, i)),
        ...
        u.opacity ||
            (f.cssHooks.opacity = {
                get: function (e, t) {
                    return Xe.test((t && e.currentStyle ? e.currentStyle.filter : e.style.filter) || "") ? 0.01 * parseFloat(RegExp.$1) + "" : t ? "1" : "";
                },
                set: function (e, t) {
                    var n = e.style,
                        i = e.currentStyle,
    ...
    (f.Animation = f.extend(ut, {
        ...
        prefilters: [
            function (e, t, n) {
                ...
                1 === e.nodeType &&
                    ...
                    "inline" === ("none" === (d = f.css(e, "display")) ? f._data(e, "olddisplay") || Oe(e.nodeName) : d) &&
                        "none" === f.css(e, "float") &&
                        (u.inlineBlockNeedsLayout && "inline" !== Oe(e.nodeName) ? (h.zoom = 1) : (h.display = "inline-block"))),
                n.overflow &&
                    ((h.overflow = "hidden"),
                    u.shrinkWrapBlocks() ||
                        c.always(function () {
                ...
                if (f.isEmptyObject(p)) "inline" === ("none" === d ? Oe(e.nodeName) : d) && (h.display = d);
                    ...
                    for (i in (g ? "hidden" in g && (v = g.hidden) : (g = f._data(e, "fxshow", {})),
                    r && (g.hidden = !v),
                    v
                        ? f(e).show()
                        : c.done(function () {
                    ...
                    p))
                        (s = ct(v ? g[i] : 0, i, c)), i in g || ((g[i] = s.start), v && ((s.end = s.start), (s.start = "width" === i || "height" === i ? 1 : 0)));
            },
        ],
        ...
        (f.speed = function (e, t, n) {
            var i = e && "object" == typeof e ? f.extend({}, e) : { complete: n || (!n && t) || (f.isFunction(e) && e), duration: e, easing: (n && t) || (t && !f.isFunction(t) && t) };
            return (
        ...
        f.each({ slideDown: dt("show"), slideUp: dt("hide"), slideToggle: dt("toggle"), fadeIn: { opacity: "show" }, fadeOut: { opacity: "hide" }, fadeToggle: { opacity: "toggle" } }, function (e, t) {
    ...
    f.fn.extend({
        val: function (e) {
            ...
            return arguments.length
                ...
                : o
                ? (t = f.valHooks[o.type] || f.valHooks[o.nodeName.toLowerCase()]) && "get" in t && void 0 !== (n = t.get(o, "value"))
                    ? n
            ...
            attr: function (e, t, n) {
                ...
                if (3 !== r && 8 !== r && 2 !== r)
                    return void 0 === e.getAttribute
                        ? f.prop(e, t, n)
                        : ((1 === r && f.isXMLDoc(e)) || ((t = t.toLowerCase()), (o = f.attrHooks[t] || (f.expr.match.bool.test(t) ? vt : ht))),
                          void 0 !== n
                              ? null === n
    ...
    f.fn.extend({
        ...
        f.extend({
            prop: function (e, t, n) {
                ...
                if (3 !== r && 8 !== r && 2 !== r)
                    return (
                        (1 === r && f.isXMLDoc(e)) || ((t = f.propFix[t] || t), (o = f.propHooks[t])),
    ...
    f.fn.extend({
        ...
        toggleClass: function (e, t) {
            ...
            return "boolean" == typeof t && "string" === n
                ...
                : this.each(function () {
                      var t, i, o, r;
                      if ("string" === n) for (i = 0, o = f(this), r = e.match(D) || []; (t = r[i++]); ) o.hasClass(t) ? o.removeClass(t) : o.addClass(t);
        ...
        hasClass: function (e) {
            var t,
                n,
                i = 0;
            for (t = " " + e + " "; (n = this[i++]); ) if (1 === n.nodeType && (" " + Tt(n) + " ").replace(xt, " ").indexOf(t) > -1) return !0;
            return !1;
        },
    }),
    ...
    function It(e) {
        return function (t, n) {
            ...
            if (f.isFunction(n)) for (; (i = r[o++]); ) "+" === i.charAt(0) ? ((i = i.slice(1) || "*"), (e[i] = e[i] || []).unshift(n)) : (e[i] = e[i] || []).push(n);
        };
    }
    function zt(e, t, n, i) {
        var o = {},
    ...
    f.extend({
        ...
        ajax: function (t, n) {
            ...
            var i,
                ...
                x = {
                    ...
                    getResponseHeader: function (e) {
                        var t;
                        if (2 === w) {
                            if (!c) for (c = {}; (t = Et.exec(s)); ) c[t[1].toLowerCase()] = t[2];
                            t = c[e.toLowerCase()];
                        }
            ...
            if (
                ...
                (x.success = x.done),
                (x.error = x.fail),
                (u.url = ((t || u.url || qt) + "").replace(At, "").replace(Lt, Mt[1] + "//")),
                (u.type = n.method || n.type || u.method || u.type),
                (u.dataTypes = f
                    .trim(u.dataType || "*")
                    .toLowerCase()
                    .match(D) || [""]),
                null == u.crossDomain && ((i = Dt.exec(u.url.toLowerCase())), (u.crossDomain = !(!i || (i[1] === Mt[1] && i[2] === Mt[2] && (i[3] || ("http:" === i[1] ? "80" : "443")) === (Mt[3] || ("http:" === Mt[1] ? "80" : "443")))))),
                u.data && u.processData && "string" != typeof u.data && (u.data = f.param(u.data, u.traditional)),
                zt(Ht, u, n, x),
                2 === w)
            )
                return x;
            for (o in ((l = f.event && u.global) && 0 == f.active++ && f.event.trigger("ajaxStart"),
            (u.type = u.type.toUpperCase()),
            (u.hasContent = !Nt.test(u.type)),
            (r = u.url),
            u.hasContent || (u.data && ((r = u.url += (_t.test(r) ? "&" : "?") + u.data), delete u.data), !1 === u.cache && (u.url = jt.test(r) ? r.replace(jt, "$1_=" + St++) : r + (_t.test(r) ? "&" : "?") + "_=" + St++)),
            u.ifModified && (f.lastModified[r] && x.setRequestHeader("If-Modified-Since", f.lastModified[r]), f.etag[r] && x.setRequestHeader("If-None-Match", f.etag[r])),
            ((u.data && u.hasContent && !1 !== u.contentType) || n.contentType) && x.setRequestHeader("Content-Type", u.contentType),
            ...
            for (o in ((k = "abort"), { success: 1, error: 1, complete: 1 })) x[o](u[o]);
            if ((d = zt(Ot, u, n, x))) {
            ...
            function T(t, n, i, o) {
                ...
                2 !== w &&
                    ...
                    c
                        ? (u.ifModified && ((T = x.getResponseHeader("Last-Modified")) && (f.lastModified[r] = T), (T = x.getResponseHeader("etag")) && (f.etag[r] = T)),
                          204 === t || "HEAD" === u.type ? (C = "nocontent") : 304 === t ? (C = "notmodified") : ((C = k.state), (y = k.data), (c = !(b = k.error))))
                    ...
                    g.fireWith(p, [x, C]),
                    l && (h.trigger("ajaxComplete", [x, u]), --f.active || f.event.trigger("ajaxStop")));
            }
            return x;
        },
        ...
        f.each(["get", "post"], function (e, t) {
            f[t] = function (e, n, i, o) {
                return f.isFunction(n) && ((o = o || i), (i = n), (n = void 0)), f.ajax(f.extend({ url: e, type: t, dataType: o, data: n, success: i }, f.isPlainObject(e) && e));
            };
        }),
        ...
        f.ajaxPrefilter("json jsonp", function (t, n, i) {
            ...
            if (a || "jsonp" === t.dataTypes[0])
                return (
                    ...
                    a ? (t[a] = t[a].replace(tn, "$1" + o)) : !1 !== t.jsonp && (t.url += (_t.test(t.url) ? "&" : "?") + t.jsonp + "=" + o),
        ...
        (f.offset = {
            setOffset: function (e, t, n) {
                ...
                "static" === d && (e.style.position = "relative"),
                    ...
                    (r = f.css(e, "top")),
                    (l = f.css(e, "left")),
                    ("absolute" === d || "fixed" === d) && f.inArray("auto", [r, l]) > -1 ? ((s = (i = c.position()).top), (o = i.left)) : ((s = parseFloat(r) || 0), (o = parseFloat(l) || 0)),
                ...
                if (this[0]) {
                    ...
                    return (
                        "fixed" === f.css(i, "position")
                            ...
                            : ((e = this.offsetParent()), (t = this.offset()), f.nodeName(e[0], "html") || (n = e.offset()), (n.top += f.css(e[0], "borderTopWidth", !0)), (n.left += f.css(e[0], "borderLeftWidth", !0))),
    ...
    (function (e, t) {
        ...
        "use strict";
        var e = { selector: "iframe", players: ["www.youtube.com", "player.vimeo.com"] },
        ...
        (i.prototype.init = function () {
                ...
                o.mobileNav.on("keydown", '[role="menuitem"]', function (t) {
                    switch ((t || event).keyCode) {
                        ...
                        case f:
                            t.preventDefault();
                            var i,
                                r = (i = e(t.target).parent().parent().children().children('[role="menuitem"]:visible')).index(t.target);
                            i.eq(r - 1).focus();
                            break;
                        case c:
                            if (
            ...
            (i.prototype._itemClick = function (e) {
                ...
                i ||
                    ...
                    (i.ul = e.next("ul")),
                    (i.parent = e.parent()),
                    i.parent.hasClass(s + "_parent-link") && ((i.parent = e.parent().parent()), (i.ul = e.parent().next("ul"))),
                    e.data("menu", i)),
                    i.parent.hasClass(s + "_collapsed")
                        ? (i.arrow.html(n.openedSymbol), i.parent.removeClass(s + "_collapsed"), i.parent.addClass(s + "_open"), i.parent.addClass(s + "_animating"), t._visibilityToggle(i.ul, i.parent, !0, e))
                        : (i.arrow.html(n.closedSymbol), i.parent.addClass(s + "_collapsed"), i.parent.removeClass(s + "_open"), i.parent.addClass(s + "_animating"), t._visibilityToggle(i.ul, i.parent, !0, e));
            }),
    ...
    jQuery(document).ready(function (e) {
        ...
        e(window).scroll(function () {
            ...
            e("#mobile_menu_slide .menu-item-has-children > a").append(e("<span/>", { class: "arrow_down" }).html('<i class="jli-down-chevron" aria-hidden="true"></i>')),
            ...
            e(".sb-toggle-left").length &&
                ...
                e("#menu-main-menu .menu-item-has-children > a").append(e("<span/>", { class: "arrow_down" }).html('<i class="jli-down-chevron-1"></i>'))),
        ...
        n.each(function () {
            ...
            jQuery(window).scroll(function () {
                e(window).scrollTop() >= 100
                    ? (e(".jl_large_menu_logo").addClass("jl_custom_height_small"), e(".options_dark_header").addClass("dark_header_menu"))
                    : (e(".jl_large_menu_logo").removeClass("jl_custom_height_small"), e(".options_dark_header").removeClass("dark_header_menu")),
        ...
        for (i = 0; i < r.length; i++) {
            ...
            s.slick({
                ...
                adaptiveHeight: !0,
                responsive: [
                    { breakpoint: 0, settings: { slidesToShow: parseInt(s.attr("data-items")) || 1 } },
                    { breakpoint: 479, settings: { slidesToShow: parseInt(s.attr("data-xs-items")) || 1 } },
                    { breakpoint: 767, settings: { slidesToShow: parseInt(s.attr("data-sm-items")) || 1 } },
                    { breakpoint: 991, settings: { slidesToShow: parseInt(s.attr("data-md-items")) || 1 } },
                    { breakpoint: 1199, settings: { slidesToShow: parseInt(s.attr("data-lg-items")) || 1 } },
                    { breakpoint: 1799, settings: { slidesToShow: parseInt(s.attr("data-xl-items")) || 1 } },
                ],
            });
        }
        fluidvids.init({ selector: "iframe", players: ["www.youtube.com", "player.vimeo.com", "www.facebook.com"] }),
            e(".quantity .jlb-btn").on("click", function (t) {
                ...
                o.attr("step") && (i = parseInt(o.attr("step"))),
                    ...
                    n.hasClass("up") ? (l = a < s ? a + i : s) : n.hasClass("down") && (l = a > r ? a - i : r),
