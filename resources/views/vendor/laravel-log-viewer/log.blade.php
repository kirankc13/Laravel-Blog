...
<head>
  ...
  <title>{{setting('admin-area-website-title')}} | System Log Viewer</title>
...
<div class="container-fluid">
  <div class="row">
    <div class="col sidebar mb-3">
      <h1><i class="fa fa-calendar" aria-hidden="true"></i> System Log Viewer</h1>
      <a href="{{ route('dashboard.index') }}" class="btn btn-md btn-primary back-button" style="margin-bottom: 10px;"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back To Dashboard</a>
        ...
        <table id="table-log" class="table table-striped" data-ordering-index="{{ $standardFormat ? 2 : 0 }}">
          ...
          @foreach($logs as $key => $log)
            <tr data-display="stack{{{$key}}}">
              ...
              @endif
              <td class="date">{{{date('l M j, Y h:i A', strtotime($log['date']))}}}</td>
              <td class="text">
                @if ($log['stack'])
                  <button type="button"
